...
Status: proposed version 1 contract for [issue #16](https://github.com/Meta-Develop/Coding-Agent-Manager/issues/16).
...
| `main.rs`, `lib.rs`, and `Cargo.toml`                      | A Tauri desktop entry point with reusable native layers.                                                                | A headless entry point and build separation; Tauri dependencies are currently unconditional.                                                                       |
